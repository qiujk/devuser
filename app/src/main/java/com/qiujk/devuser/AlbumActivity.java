...
public class AlbumActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTakeVideo.setOnClickListener(takeVideoClick);
        mTakePhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    if (Build.VERSION.SDK_INT >= 23) {
                        int checkCallPhonePermission = ContextCompat.checkSelfPermission(AlbumActivity.this, Manifest.permission.CAMERA);
                        if (checkCallPhonePermission != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(AlbumActivity.this, new String[]{Manifest.permission.CAMERA}, 3);
                            return;
                        } else {
                            takePhoto();
                        }
                    ...
                    Log.e(tag, "mTakePhoto error:" + ex.getMessage());
                }
            }
        });
        ...
        mChoosePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Log.e(tag, "mChoosePhoto error: " + ex.getMessage());
                }
            }
        });
    }
    ...
    //take video
    private View.OnClickListener takeVideoClick = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            try {
                if (Build.VERSION.SDK_INT >= 23) {
                    int checkCallPhonePermission = ContextCompat.checkSelfPermission(AlbumActivity.this, Manifest.permission.CAMERA);
                    if (checkCallPhonePermission != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(AlbumActivity.this, new String[]{Manifest.permission.CAMERA}, 4);
                        return;
                    } else {
                        takeVideo();
                    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        try {
            switch (requestCode) {
                case 1://CHOOSE_PHOTO
                    if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        Toast.makeText(this, "you denied the choose photo permission", Toast.LENGTH_SHORT).show();
                    }
                    break;
                case 2://CHOOSE_VIDEO
                    if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        Toast.makeText(this, "you denied the choose video permission", Toast.LENGTH_SHORT).show();
                    }
                    break;
                case 3://take photo
                    if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        Toast.makeText(this, "you denied the take photo permission", Toast.LENGTH_SHORT).show();
                    }
                    break;
                case 4://take video
                    if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Log.e(tag, "onRequestPermissionsResult error: " + ex.getMessage());
        }
    }
            ...
            switch (requestCode) {
                case TAKE_VIDEO:
                    if (resultCode == RESULT_OK) {
                        try {
                            if (videoUri != null) {
                                Toast.makeText(this, videoUri.getPath(), Toast.LENGTH_SHORT).show();
                                //imageView.setVisibility(View.INVISIBLE);
                                videoView.setVisibility(View.VISIBLE);
                                String videoString = videoUri.getPath();
    ...
    private void takeVideo() {
        try {
            ...
            Log.e(tag, "takeVideo error:" + ex.getMessage());
        }
    }
    ...
    private void openAlbumAndVideo(int type) {
        try {
            ...
            Log.e(tag, "openAlbumAndVideo error: " + ex.getMessage());
        }
    }
